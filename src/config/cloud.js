...
export const CLOUD_STORAGE_BASE_URL = 'https://storage.googleapis.com/exchange-rates-fabled-emblem-451602';

// Backend API base URL
export const API_BASE_URL = 'https://backend-284998006367.us-central1.run.app';
...
export const GCE_CONFIG = {
  PROJECT_ID: 'fabled-emblem-451602-f6',
  ZONE: 'us-central1-c',
  get API_URL() {
